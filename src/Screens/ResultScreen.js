...
import { IoIosCheckmarkCircle, IoIosCloseCircle, IoIosCloseCircleOutline } from "react-icons/io";
            ...
            <Resultcards className="row">
                <Card>
                    <TopBar className="row">
                        <Profileimg>
                            <img src={bg} alt="dp" style={{ height: "100%", width: "100%", borderRadius: "50%" }} ></img>
                        </Profileimg>
                ...
                <Card>
                    ...
                    <Prediction className="row">
                        ...
                        <img src={larka} alt="larka" style={{ height: "10vw", marginLeft: "3vw" }}></img>
                    </Prediction>
                    <Msg1 className="row">
                        <p style={{ color: "#FF7F46" }}>Unfortunately your child has been diagnosed with
Dyslexia with the prediction of 95%.</p>
                    </Msg1>
                    <Msg2 className="row">
                        <p> We would recommend that you consider
                        any of the nearest educational phycologist
                        for your child. The phycologist will help your child
 in improving his condition</p>
                    </Msg2>
...
const List = ({ Answer, index }) => {

    return (
        <Question className="row">
            <p style={{ color: "white", fontSize: "1.3vw" }}>Question {index + 1}</p>
            {Answer === 1 ? (
                <IoIosCheckmarkCircle style={{ color: "#3BB54A", fontSize: "2vw" }}></IoIosCheckmarkCircle>
            ) : (
                <IoIosCloseCircle style={{ color: "#F44336", fontSize: "2vw" }}></IoIosCloseCircle>
            )}
